#!/usr/bin/env python3
"""
Fixed Python Attendance Data Extractor
Exact match to the working sample application
"""
...
fk_dll.FK_GetGeneralLogData.argtypes = [
    ...
    # ctypes.c_char_p,          # apEnrollNumber (char*)
    ctypes.POINTER(ctypes.c_char),  # ✅ for output char* buffer
...
def extract_attendance_data() -> Dict[str, Any]:
    ...
    try:
        ...
        enroll_number = ctypes.create_string_buffer(24)
        ...
        while True:
            ...
            if get_result == 1:  # RUN_SUCCESS
                ...
                record = {
                    ...
                    "UserId": enroll_number.value.decode('ascii'),  # 🔁 decode from bytes
...
def main():
    """Main function"""
    print("=== Fixed Python Attendance Data Extractor ===")
    print("Using exact same parameters as working sample application")
