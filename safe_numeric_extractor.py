#!/usr/bin/env python3
"""
Safe Numeric Python Attendance Data Extractor
Uses only numeric ID functions to avoid string buffer issues
"""
...
def setup_function_signatures(dll):
    ...
    # FK_GetGeneralLogData (numeric ID only)
...
def extract_attendance_data():
    """Extract attendance data from device using only numeric ID functions"""
    print("=== Safe Numeric Python Attendance Data Extractor ===")
    print("Uses only numeric ID functions to avoid string buffer issues")
    ...
    try:
        ...
        # Step 3: Extract attendance records using numeric ID function only
        print("Step 3: Extracting attendance records (numeric ID only)...")
