...
public class FKAttendDLL
{
    ...
    [DllImport("FK623Attend.dll", CharSet = CharSet.Ansi)]
     public static extern int FK_GetSuperLogData(
        int anHandleIndex,
        ref UInt32 apnSEnrollNumber,
        ref UInt32 apnGEnrollNumber,
    ...
    public static void GetIoModeAndDoorMode(Int32 nIoMode, ref int vIoMode, ref int vDoorMode, ref int vInOut)
    {
        ...
        //֮ǰ�Ķ�����bug��������ע�͵�����  The previous definition was buggy. Here is the code to comment out
        //vIoMode = vbyteKind[0];
...
public enum FKMax
{
    ...
    SIZE_USERDOORINFO_V3 = 16 + USER_ID_LENGTH,
    SIZE_USERDOORINFO_V4 = 16 + USER_ID_LENGTH13_1,

    VER_USERCUSTOMINFO_V1 = 1,
    SIZE_USERCUSTOMINFO_V1 = 644,
    SIZE_USERVID = 64
}
